...
oepoll = OEPoll(me)
call = me
Admin = InexBots["u8f5f2b2be04d5b895cf23ff92c600c55"]
Owner = ["u8f5f2b2be04d5b895cf23ff92c600c55"]
Stiles = "u8f5f2b2be04d5b895cf23ff92c600c55"
                    ...
                    if text is None:
                        ...
                        if InexBotsList == Menu["1"]:
                          if Dari in Owner or Dari in meM:
                            ...
                            me.sendMessage(Pesan, str(Res)+Stiles+" http://line.me/D\n╰━──────────────━╯")
                        ...
                        if InexBotsList == "ping":
                          if Dari in Owner or Dari in meM:
                            kk1.sendMessage(Pesan, "✯ͥ ͣ ͫ͢Lover༻_1.࿐")
                            kk2.sendMessage(Pesan, "✯ͥ ͣ ͫ͢Lover༻_2.࿐")
                            kk3.sendMessage(Pesan, "✯ͥ ͣ ͫ͢Lover༻_3.࿐")
                            kk4.sendMessage(Pesan, "✯ͥ ͣ ͫ͢Lover༻_4.࿐")
                            kk5.sendMessage(Pesan, "✯ͥ ͣ ͫ͢Lover༻_5.࿐")
                        ...
                        if InexBotsList == "cb" or InexBotsList == "skill":
                          if Dari in Owner or Dari in meM:
                            ...
                            if has == "OK":sil = "Lover is Here"
                            else:sil = "ֆǟӄɨȶ"
                            if has1 == "OK":sil1 = "Lover is Here"
                            else:sil1 = "ֆǟӄɨȶ"
                            me.sendMessage(Pesan, "🄺🄸🄲🄺 : {} \n🄸🄽🅅🄸🅃🄴 : {}".format(sil1,sil))
