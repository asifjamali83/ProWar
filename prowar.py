...
oepoll = OEPoll(me)
call = me
Admin = InexBots["u35577e52b245ace6deb64e33a301f3b0"]
...
respontags = {
    "Auto_text": "╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩",
    "Auto_pM": "⪨⪩┅༐┅͜͡❇║ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩"
}
Sid={
    "Tar":{},
    "Red":{},
...
Line_Apikey = "u35577e52b245ace6deb64e33a301f3b0"
Extr = me.getContact(Line_Apikey).displayName
Import_Server = ["u35577e52b245ace6deb64e33a301f3b0"]
for Allbots in Jaka:
                    ...
                    if text is None:
                        ...
                        if InexBotsList == Menu["1"]:
                          if Dari in Owner or Dari in meM:
                            ...
                            me.sendMessage(Pesan, str(Res)+Stiles+" 􀰂􀰂✯ͥ ͣ ͫ͢ŚhÀH•ŹÀ!η࿐❥\n╰━──────────────━╯")
                        ...
                        if InexBotsList.startswith(Menu["33"]):
                          if Dari in Owner or Dari in meM:
                            ...
                            me.sendMessage(Pesan, "Succeeded broadcast ke {} group".format(str(len(groups))))
                          ...
                          if Dari in Owner or Dari in meM:
                            if msg.toType == 2:
                                ...
                                if group.preventedJoinByTicket == False:
                                    ...
                                    group.preventedJoinByTicket = False
                                    me.updateGroup(group)
                                    me.sendMessage(Pesan, "Succeeded membuka Qr")
                          ...
                          if Dari in Owner or Dari in meM:
                            if msg.toType == 2:
                                ...
                                if group.preventedJoinByTicket == True:
                                    ...
                                    me.updateGroup(group)
                                    me.sendMessage(Pesan, "Succeeded menutup Qr")
                        ...
                        if InexBotsList == "clearban" or InexBotsList == "Clearban":
                          if Dari in Owner or Dari in meM:
                            me.sendMessage(Pesan, "Succeeded menghapus {} user blacklist".format(str(len(InexBots["blacklist"]))))
                            InexBots["blacklist"] = {}
                        ...
                        if InexBotsList == "cek" or InexBotsList == "skill":
                          if Dari in Owner or Dari in meM:
                            ...
                            try:kk3.inviteIntoGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has = "OK"
                            except:has = "NOT"
                            try:kk3.kickoutFromGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has1 = "OK"
                            except:has1 = "NOT"
                            if has == "OK":sil = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                            else:sil = "ֆǟӄɨȶ"
                            if has1 == "OK":sil1 = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                            ...
                            try:kk4.inviteIntoGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has = "OK"
                            except:has = "NOT"
                            try:kk4.kickoutFromGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has1 = "OK"
                            except:has1 = "NOT"
                            if has == "OK":sil = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                            else:sil = "ֆǟӄɨȶ"
                            if has1 == "OK":sil1 = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                            ...
                            try:kk5.inviteIntoGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has = "OK"
                            except:has = "NOT"
                            try:kk5.kickoutFromGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has1 = "OK"
                            except:has1 = "NOT"
                            if has == "OK":sil = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                            else:sil = "ֆǟӄɨȶ"
                            if has1 == "OK":sil1 = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                        ...
                        if InexBotsList == "cek js" or InexBotsList == "skill js":
                          if Dari in Owner or Dari in meM:
                            try:jss.inviteIntoGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has = "OK"
                            except:has = "NOT"
                            try:jss.kickoutFromGroup(Pesan, ["u35577e52b245ace6deb64e33a301f3b0"]);has1 = "OK"
                            except:has1 = "NOT"
                            if has == "OK":sil = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
                            else:sil = "ֆǟӄɨȶ"
                            if has1 == "OK":sil1 = "ś̵̢̨͕̋̽͛̇̿̚e̷̗͍̩͚͚̗͔̾ḩ̴̛̞̬̝̟̘̭̾̊͑́͛̒̓̈́͒ͅȃ̴̞͇̗̭̪͖̦̜̫̞͗͑́̈́̀͘t̶̮͕͉̂̉̐̀́͜"
          ...
          if InexBots["bot"] == True:
            ...
            if Denwar == "autojoin on":
              if Dari in Owner or Dari in meM:
                  ...
                  me.sendMessage(Pesan,"join d activated.....")
            if Denwar == "autojoin off":
              if Dari in Owner or Dari in meM:
                  InexBots["autoJoin"] = False
                  me.sendMessage(Pesan,"join d non activated.....")
            if Denwar == "pm on":
              if Dari in Owner or Dari in meM:
                  InexBots["arespon"] = True
                  me.sendMessage(Pesan,"Respon pm d activated.....")
            if Denwar == "pm off":
              if Dari in Owner or Dari in meM:
                  InexBots["arespon"] = False
                  me.sendMessage(Pesan,"Respon pm d nonactivated.....")
            if Denwar == "autoleave on":
              if Dari in Owner or Dari in meM:
                  InexBots["autoLeave"] = True
                  me.sendMessage(Pesan,"Leave d activated.....")
            if Denwar == "autoleave off":
              if Dari in Owner or Dari in meM:
                  InexBots["autoLeave"] = False
                  me.sendMessage(Pesan,"Leave d non activated.....")
            if Denwar == "admin on":
              if Dari in Owner or Dari in meM:
                  InexBots["addOwner"] = True
                  me.sendMessage(Pesan,"Send the contact...")
            if Denwar == "admin off":
              if Dari in Owner or Dari in meM:
            ...
            if Denwar == "my pict":
              if Dari in Owner or Dari in meM:
                  ...
                  me.sendMessage(Pesan,"Send photo.....")
            if Denwar == "bot pict":
              if Dari in Owner or Dari in meM:
              ...
              if Dari in Owner or Dari in meM:
                  ...
                  if spl == 'on':
                      ...
                      if Pesan in pro["Penyelamat"]:
                          ...
                          ginfo = me.getGroup(Pesan)
                          msgs = "Succeeded mengactivated semua protect\nDi Group : " +str(ginfo.name)
                      me.sendMessage(Pesan, "「Diactivated」\n" + msgs)
                  if spl == 'off':
                        if Pesan in pro["Pintu"]:
                        ...
                        if Pesan in pro["Penyelamat"]:
                             ...
                             ginfo = me.getGroup(Pesan)
                             msgs = "Succeeded menonactivated semua protect\nDi Group : " +str(ginfo.name)
                        else:
                             ginfo = me.getGroup(Pesan)
                             msgs = "Semua protect already off\nDi Group : " +str(ginfo.name)
                        me.sendMessage(Pesan, "「Disabled」\n" + msgs)
              ...
              if Dari in Owner or Dari in meM:
                 ...
                 for target in targets:
                     if target not in InexWars:
                         try:
                             Owner.append(target)
                             me.sendMessage(Pesan,"Added successfully admin")
                         except:
                             pass
              ...
              if Dari in Owner or Dari in meM:
                 ...
                 for target in targets:
                     if target not in InexWars:
                         try:
                             Owner.remove(target)
                             me.sendMessage(Pesan,"Succeeded remove admin")
                         except:
                             pass
            ...
            if msg.toType == 0 or msg.toType == 2:
                ...
                if msg.contentType == 1:
                    if meM in InexBots["SKfoto"]:
                         ...
                         me.sendMessage(R,"Foto Succeeded dirubah")
                if msg.contentType == 1:
                    if InexBots["changePicture"] == True:
                        path = me.downloadObjectMsg(R)
                        InexBots["changePicture"] = False
                        me.updateProfilePicture(path)
                        me.sendMessage(R, "Succeeded mengubah foto profile bot")
                if msg.contentType == 1:
                    if InexBots["changePicture"] == True:
                        ...
                        kk1.sendMessage(R, "Succeeded mengubah foto profile bot")
                        kk2.updateProfilePicture(path2)
                        kk2.sendMessage(R, "Succeeded mengubah foto profile bot")
                        kk3.updateProfilePicture(path3)
                        kk3.sendMessage(R, "Succeeded mengubah foto profile bot")
                        kk4.updateProfilePicture(path4)
                        kk4.sendMessage(R, "Succeeded mengubah foto profile bot")
                        kk5.updateProfilePicture(path5)
                        kk5.sendMessage(R, "Succeeded mengubah foto profile bot")
                        jss.updateProfilePicture(path6)
                        jss.sendMessage(R, "Succeeded mengubah foto profile bot")
        if rank.type == 13:
            ...
            if InexBots["addOwner"] == True:
              if msg.contentMetadata["mid"] in Owner:
                  me.sendMessage(R,"Contact itu already jadi admin")
                  InexBots["addOwner"] = True
              else:
                  Owner.append(msg.contentMetadata["mid"])
                  InexBots["addOwner"] = True
                  me.sendMessage(R,"Added successfully ke admin")
            if InexBots["dellOwner"] == True:
              if msg.contentMetadata["mid"] in Owner:
                  Owner.remove(msg.contentMetadata["mid"])
                  me.sendMessage(R,"Succeeded remove dari admin")
              else:
                  InexBots["dellOwner"] = True
